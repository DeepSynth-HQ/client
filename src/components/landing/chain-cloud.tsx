...
const Icons = {
  aptos: () => (
    <svg
      ...
      style={{ background: "new 0 0 479.3 481.2" }}
      xmlSpace="preserve">
  ...
  arbitrum: () => (
    <svg
      ...
      style={{ background: "new 0 0 2500 2500" }}
      xmlSpace="preserve">
      <style type="text/css">{`
      .st0{fill:none;}
      .st1{fill:#213147;}
  ...
  binance: () => (
    <svg
      ...
      style={{ background: "new 0 0 2496 2496" }}
      xmlSpace="preserve">
      <g>
        <path
  ...
  near: () => (
    <svg
      ...
      fill="white"
      viewBox="0 0 90.1 90"
      style={{ background: "new 0 0 90.1 90" }}
      xmlSpace="preserve">
  ...
  polkadot: () => (
    <svg
      ...
      style={{ background: "new 0 0 1326.1 1410.3" }}
      xmlSpace="preserve">
      <style type="text/css">{`
      .st0{fill:#E6007A;}
    `}</style>
  ...
  sui: () => (
    <svg
      ...
      <style>{".st0{fillRule:evenodd;clipRule:evenodd;fill:#4DA2FF;}"}</style>
      <path
        className="st0"
...
export function ChainCloud() {
  return (
    <section className="relative z-0 mx-auto flex size-full h-svh items-center justify-center overflow-hidden bg-gradient-to-b from-background to-[hsl(var(--background-secondary))]">
      ...
      <IconCloud
        icons={[
          <Icons.aptos key="aptos" />,
          <Icons.arbitrum key="arbitrum" />,
          <Icons.binance key="binance" />,
          <Icons.ethereum key="ethereum" />,
          <Icons.hyperliquid key="hyperliquid" />,
          <Icons.near key="near" />,
