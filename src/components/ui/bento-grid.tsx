...
const BentoCard = ({
  ...
  <div
    ...
    <div className="pointer-events-none z-10 flex h-full transform-gpu flex-col justify-end gap-1 bg-gradient-to-t from-secondary/80 to-black/60 p-6 transition-all duration-300">
